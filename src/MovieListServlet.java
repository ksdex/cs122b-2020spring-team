    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(genre!=null){
            try {
                ...
                String query = "SELECT movieid from genres_in_movies where genreId="+genre;
            ...
            try {
                ...
                JsonArray jsonArray = new JsonArray();
                ResultSet rs0 = statement0.executeQuery("SELECT id from movies where title like '" + startwith + "%' or title like '"+startwith.toUpperCase()+"%'");
                while(rs0.next()){
                    String id = rs0.getString("id");
                    Statement statement = dbcon.createStatement();

                    // Perform the query
                    ResultSet rs = statement.executeQuery("SELECT * from movies as m, ratings as r where m.id = r.movieId and id = '" + id + "'");
